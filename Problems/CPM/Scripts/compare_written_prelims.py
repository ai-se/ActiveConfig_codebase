...
plt.figlegend([r4,  r5], ["Siegmund", "Guo (2N)", "Guo (PW)",  "Sarkar", "WHAT"], frameon=False, loc='upper center', bbox_to_anchor=(0.5, 1.023), fancybox=True, ncol=5)
...
plt.tight_layout()
# plt.show()
plt.savefig('compare_graph_h_sarkar.eps', bbox_inches='tight', format='eps')